...
| Mục | Nội dung |
|-----|----------|
| Họ và tên | Nguyen Phuong Nam |
| Mã học viên | 2A202601952 |
| Repo | https://github.com/pNam1802/K3-Day12-2A202601952-NguyenPhuongNam |

## Service

| Mục | Nội dung |
|-----|----------|
| Public URL | https://agent-production-a5f0.up.railway.app |
| Platform | Railway |
...
(9 request đầu của batch này qua được vì 1 quota đã dùng bởi lệnh #4 ở trên
cùng cửa sổ 60s — tổng cộng đúng 10 request "200" rồi mới bắt đầu 429, khớp
RATE_LIMIT_PER_MINUTE=10)
```
